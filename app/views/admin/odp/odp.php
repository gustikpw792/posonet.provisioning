                    ...
                    <div class="modal-body" id="step2">
                        <div class="row">
                            <form id="form" action="#" class="form-horizontal">
                                <input type="text" name="id_odp" hidden>
                                <div class="col-md-6 b-r">
                                    <div class="form-group"><label class="col-md-3 control-label ">ODP Name</label>
                                        <div class="col-md-9"><input name="odp_name" type="text" class="form-control" placeholder="MYA-01"> <span class="help-block m-b-none"></span>
                                        </div>
                                    </div>
                                    <div class="form-group"><label class="col-md-3 control-label ">Latitude,Longitude</label>
