<audio id="myAudio">
  <source src="<?php echo base_url() ?>assets/sound/checkout_scanner_beep.mp3" type="audio/mpeg">
  Your browser does not support the audio element.
</audio>
<audio id="myAudioError">
  <source src="<?php echo base_url() ?>assets/sound/open_ended.mp3" type="audio/mpeg">
  Your browser does not support the audio element.
</audio>
